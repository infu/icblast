...
exports["default"] = exports.actress = void 0;
...
var _identity2 = require("@dfinity/identity");
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // import pLimit from "p-limit";
...
var hashIdentity = function hashIdentity(pass) {
  ...
  var identity = _identity2.Ed25519KeyIdentity.generate(entropy);
  return identity;
};
