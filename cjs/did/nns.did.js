...
var idlFactory = function idlFactory(_ref) {
  ...
  var NeuronId = IDL.Record({
    id: IDL.Nat64
  });
  var Followees = IDL.Record({
    followees: IDL.Vec(NeuronId)
  });
  var AccountIdentifier = IDL.Record({
  ...
  var Merge = IDL.Record({
    source_neuron_id: IDL.Opt(NeuronId)
  });
  ...
  var MergeMaturity = IDL.Record({
    percentage_to_merge: IDL.Nat32
  });
  var Amount = IDL.Record({
    e8s: IDL.Nat64
  });
  ...
  var AddOrRemoveNodeProvider = IDL.Record({
    change: IDL.Opt(Change)
  });
  var Motion = IDL.Record({
  ...
  var DisburseResponse = IDL.Record({
  ...
  var ManageNeuronResponse = IDL.Record({
