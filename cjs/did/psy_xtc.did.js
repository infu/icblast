...
var idlFactory = function idlFactory(_ref) {
  ...
  var TxReceipt = IDL.Variant({
    Ok: IDL.Nat,
    Err: TxError
  });
  var TransactionId = IDL.Nat64;
  var BurnError = IDL.Variant({
    InsufficientBalance: IDL.Null,
    InvalidTokenContract: IDL.Null,
    NotSufficientLiquidity: IDL.Null
  });
  var BurnResult = IDL.Variant({
    Ok: TransactionId,
    Err: BurnError
  });
  var TransactionStatus = IDL.Variant({
    FAILED: IDL.Null,
    SUCCEEDED: IDL.Null
  });
  var EventDetail = IDL.Variant({
    Approve: IDL.Record({
      to: IDL.Principal,
      from: IDL.Principal
    }),
  ...
  var EventsConnection = IDL.Record({
    data: IDL.Vec(Event),
  ...
  var TxReceiptLegacy = IDL.Variant({
    Ok: IDL.Nat,
    Err: IDL.Variant({
      InsufficientAllowance: IDL.Null,
      InsufficientBalance: IDL.Null
  ...
  var ResultCall = IDL.Variant({
    Ok: IDL.Record({
      "return": IDL.Vec(IDL.Nat8)
    }),
    Err: IDL.Text
  });
  var CreateResult = IDL.Variant({
    Ok: IDL.Record({
      canister_id: IDL.Principal
    }),
    Err: IDL.Text
  });
  var ResultSend = IDL.Variant({
    Ok: IDL.Null,
    Err: IDL.Text
  });
  return IDL.Service({
    ...
    events: IDL.Func([IDL.Record({
      offset: IDL.Opt(IDL.Nat64),
      limit: IDL.Nat16
    })], [EventsConnection], ["query"]),
    ...
    mint_by_icp_recover: IDL.Func([IDL.Opt(IDL.Vec(IDL.Nat8)), IDL.Nat64, IDL.Principal], [TxReceipt], []),
    ...
    wallet_balance: IDL.Func([], [IDL.Record({
      amount: IDL.Nat64
    })], ["query"]),
    wallet_call: IDL.Func([IDL.Record({
      args: IDL.Vec(IDL.Nat8),
      cycles: IDL.Nat64,
      method_name: IDL.Text,
      canister: IDL.Principal
    })], [ResultCall], []),
    wallet_create_canister: IDL.Func([IDL.Record({
      controller: IDL.Opt(IDL.Principal),
      cycles: IDL.Nat64
    })], [CreateResult], []),
    wallet_create_wallet: IDL.Func([IDL.Record({
      controller: IDL.Opt(IDL.Principal),
      cycles: IDL.Nat64
    })], [CreateResult], []),
    wallet_send: IDL.Func([IDL.Record({
      canister: IDL.Principal,
      amount: IDL.Nat64
    })], [ResultSend], [])
  });
